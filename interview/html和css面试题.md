...
3.  var el = document.getElementById('el') ;
    ...
    console.log(window.getComputedStyle(element).getPropertyValue('width')); // jQuery 的 CSS()方法就是用此方法的；
...
2.  javascript 中的 offsetWidth、clientWidth、innerWidth 及相关属性方法
